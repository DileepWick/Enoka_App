...
const Login = () => {
    ...
    const [firebaseResponse, setFirebaseResponse] = useState(null); // State to store Firebase response
    ...
    return (
        <div>
            {userLoggedIn && userStatus && <Navigate to={'/'} replace={true} />}
                ...
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    {firebaseResponse && (
                        <div className="mt-4 bg-gray-100 p-2 rounded">
                            <pre>{JSON.stringify(firebaseResponse, null, 2)}</pre>
                        </div>
                    )}
                </div>
            </main>
