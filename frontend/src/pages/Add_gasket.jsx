...
export default function AddItemForm() {
    ...
    const fetchData = async () => {
      try {
        const [vendorsResponse, brandsResponse, enginesResponse] = await Promise.all([
          axios.get("https://enokaback-7e8aa9803d2c.herokuapp.com/api/vendors"),
          axios.get("https://enokaback-7e8aa9803d2c.herokuapp.com/api/brands"),
          axios.get("https://enokaback-7e8aa9803d2c.herokuapp.com/api/engines"),
        ]);
  ...
  const handleAddNew = async () => {
    ...
    try {
      ...
      const response = await axios.post(`https://enokaback-7e8aa9803d2c.herokuapp.com/api/${url}`, {
        [key]: newItemName
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://enokaback-7e8aa9803d2c.herokuapp.com/api/gaskets", formData);
