        ...
        <View style={styles.table}>
          ...
          {items.map((item, index) => (
            <View key={index} style={styles.tableRow}>
              ...
              <Text style={styles.tableCellUnits}>{item.quantity || 0}</Text>
              <Text style={styles.tableCellOther}>{item.price || 0}</Text>
              <Text style={styles.tableCellOther}>{item.discount || 0}</Text>
              <Text style={styles.tableCellOther}>
                {calculateGrossPrice(item.price || 0, item.quantity || 0, item.discount || 0)}
              </Text>
            </View>
          ))}
        </View>
...
const Invoice = ({
  ...
  const billBranch = sessionStorage.getItem("branch") || "";
